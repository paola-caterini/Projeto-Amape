...
class Telas(Funçao):
    ...
    def telaUsuarios(self):
        ...
        self.bt_Search = Button(self.frameTela_Usuarios,image=self.img_Search,highlightthickness=0,border=0)
      ...
      #########################################################################################
        ...
        self.listaCli = ttk.Treeview(self.frame_2, height=3,column=("col1", "col2", "col3", "col4", "col5", "col6", "col7"))
        ...
        self.listaCli.heading("#5", text="C1")
        self.listaCli.heading("#6", text="C2dade")
        self.listaCli.heading("#7", text="C3dade")
        self.listaCli.column("#0", width=100)
        ...
        style.configure("Treeview",background="blue",foreground="black",rowheight=25,fieldbackground="grey")
